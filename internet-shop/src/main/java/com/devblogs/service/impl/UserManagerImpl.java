...
import com.devblogs.dao.UserDao;
import com.devblogs.model.User;
import com.devblogs.service.MailEngine;
import com.devblogs.service.UserExistsException;
import com.devblogs.service.UserManager;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.devblogs.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see com.devblogs.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
