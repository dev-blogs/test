...
JNIEXPORT jobject JNICALL Java_Win32RegKey_getValue(JNIEnv* env, 
...
JNIEXPORT void JNICALL Java_Win32RegKey_setValue(JNIEnv* env, 
...
Java_Win32RegKeyNameEnumeration_hasMoreElements(JNIEnv* env, 
   jobject this_obj)
{  jclass this_class;
   jfieldID id_index;
   jfieldID id_count;
